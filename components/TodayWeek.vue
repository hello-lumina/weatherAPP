<template>
    <div>
        <div class="header">
            ...
            <div class="units">
                <div @click="setActiveF" :class="{ 'units__item': activeUnits!='F', 'units__item active': activeUnits=='F' }"><span>&deg;F</span></div>
                <div @click="setActiveC" :class="{ 'units__item': activeUnits!='C', 'units__item active': activeUnits=='C' }"><span>&deg;C</span></div>
            </div>
        </div>
            ...
            <div :class="{ 'card': weatherInfo, 'skeleton-loading-card': !weatherInfo }">
                <p v-if="weatherInfo">{{ dayOne }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureOne }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureOne }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ dayTwo }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureTwo }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureTwo }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ dayThree }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureThree }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureThree }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ dayFour }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureFour }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureFour }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ dayFive }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureFive }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureFive }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ daySix }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureSix }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureSix }}&deg;{{ temperatureSign }}</span></p>
            </div>
            ...
            <div :class="{ 'card': weatherInfo!=null, 'skeleton-loading-card': weatherInfo==null }">
                <p v-if="weatherInfo">{{ daySeven }}</p>
                    <svg v-if="weatherInfo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60">
                        ...
                        <p v-if="weatherInfo">{{ minTemperatureSeven }}&deg;{{ temperatureSign }}  <span class="color-bg-darker">{{ maxTemperatureSeven }}&deg;{{ temperatureSign }}</span></p>
            </div>
        </div>
        </div>
</template>
